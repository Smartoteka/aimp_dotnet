...
namespace AIMP.SDK.Threading
{
    ...
    public interface IAimpServiceSynchronizer : IAimpService
    {
        ...
        ///     True - the method will not return control until operation has been completed (Not recommended).
        ///     Otherwise, task will be queued and executed when main thread is idle. Default value is False.
        /// </param>
