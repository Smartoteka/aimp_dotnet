...
namespace AIMP.SDK.Visuals
{
    ...
    public class AimpVisualData
    {
        ...
        ///     This field is populated only if the extension returns the
        ///     <see cref="AimpVisualFlags.AIMP_VISUAL_FLAGS_RQD_DATA_SPECTRUM" /> flag in the GetFlags method.
        ///     <para>
        ...
        ///     This field is populated only if the extension returns the
        ///     <see cref="AimpVisualFlags.AIMP_VISUAL_FLAGS_RQD_DATA_WAVE" /> flag in the GetFlags method.
        ///     <para>
