...
namespace AIMP.SDK.AlbumArtManager
{
    ...
    public interface IAimpExtensionAlbumArtCatalog2
    {
        ...
        /// <param name="image">
        ///     Image instance, can be null if catalog does not provides an ability to select album art immediately.
        ///     For example, if the extension just open external link via Internet browser.
        /// </param>
