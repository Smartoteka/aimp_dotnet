...
namespace AIMP.SDK
{
    ...
    public interface IAimpStream : IDisposable
    {
        ...
        /// </summary>
        /// <param name="buffer">
        ///     When this method returns, contains the specified byte array with the values from the current
        ///     stream.
        /// </param>
        ...
        /// <param name="writen">
        ///     Parameter displays what bytes has been really written to the stream.
